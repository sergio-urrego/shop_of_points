    ...
    <header id="header" class="contenedor-header">
        ...
        <div class="fondo-animado">
         ...
         <nav class="menu">
             ...
             <ul class="ul-enlaces">
                 <li>
                     <a href="../html/agregar_clientes_gerente.php" title="">
                    ...
                    <li> 
                        <a href="../html/listado_clientes.php" title="">
...
<!--formulario de actualización-->
    <div class="formulario top translate" id="actualizar">
        <form class="form-control w-50" id="form" name="form"  enctype="multipart/form-data" method="post">
            ...
            <div class="form-control border-white">
                <button type="button" class="btn btn-primary" onclick="actualizarusuariodesdegerente()" >Guardar</button>
            </div>
        </form>
    ...
    <div class="consultas desplegar" id="consultar">
        <form class="form-control w-50">
            ...
            <div class="form-control border-white text-align-center">
                <label for="">Nombre</label>
                <input type="text" disabled class="form-control w-90 rellenar" name="cliente_nombre">
            </div>

            <div class="form-control border-white">
                <label for="">Apellido  :</label>
                <input type="text"disabled class="form-control w-90 rellenar" name="cliente_Apellido">
            </div>

            <div class="form-control border-white">
                <label for="">Celular :</label>
                <input type="number" disabled class="form-control w-90 rellenar" name="cliente_celular">
            </div>

            <div class="form-control border-white ">
                <label for="">Correo :</label>
                <input type="text" disabled class="form-control w-90 rellenar" name="cliente_correo">
            </div>
