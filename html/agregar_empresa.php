            ...
            <div class="container mt-5 ">
                <form id="form" name="form" form class="form col-10 col-md-7"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 d-flex align-items-center flex-row-reverse">
                            <input type="number" class="form-control" placeholder="Porcentaje" name="porcentaje" id="porcentaje">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-percent" viewBox="0 0 16 16">
                                    <path d="M13.442 2.558a.625.625 0 0 1 0 .884l-10 10a.625.625 0 1 1-.884-.884l10-10a.625.625 0 0 1 .884 0zM4.5 6a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm0 1a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zm7 6a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm0 1a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
                            </svg>
                        </div>

                        <div class="col-md-6 d-flex align-items-center flex-row-reverse">
                            <input type="number" class="form-control" placeholder="valor por punto" name="valor" id="valor">
                    ...
                    <br>
                    <div class="d-grid">
                        <button type="button" class="btn colorverde" onclick="insertarEmpresa()">Enviar</button>
                    </div>
