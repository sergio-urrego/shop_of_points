...
<head>
    ...
    <link rel="stylesheet" href="../css/historial_clientes.css">
</head>
<body>
...
<div class="arriba">    
                    ...
                    if (!isset($_POST["buscar"])){
                        $consulta="SELECT c.cedula, c.nombre, c.apellidos, c.celular, c.correo, u.nit_empresa 
                                     ...
                                     inner join  detalles_clientes u on c.cedula = u.cedula_cliente  
                                            WHERE u.nit_empresa='$_SESSION[empresa]'";
    ...
    <div class="consultas desplegar" id="consultar">
        <form class="form-control w-50" action="../html/historial_info_clientes.php" method="post" >
