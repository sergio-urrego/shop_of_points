    ...
    <div class="row">
        ...
        <div class="col-4">
            <div class="container2">
                <div class="cuadro">
                    <?php 
                        $consulta2="SELECT * FROM clientes c inner join  detalles_clientes u on c.cedula = u.cedula_cliente where u.usuario_borro is not null ";
    ...
    <script>
      $(document).ready(function() {
        $('.enviarbtn').click(function() {
          ...
          $.post('../php/update/activarcliente_admin.php', { dato: dato }, function(response) {
