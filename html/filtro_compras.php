        ...
        <section class="table__body">
            <table class="tabla">
                ...
                <tbody class="icono">
                        <?php
                        if($validacion==false  ){
                        $consulta="SELECT * FROM acumulado_compras WHERE nit_empresa='$_SESSION[empresa]' and cedula_cliente='$_SESSION[user]'  ";
                        ...
                        <?php }}else {
                            if($_POST["buscar"]==''){
                                $consulta="SELECT * FROM acumulado_compras WHERE nit_empresa='$_SESSION[empresa]' and cedua_cliente='$_SESSION[user]'  ";
                                $resultado=mysqli_query($con,$consulta);
                                while ($empresa=mysqli_fetch_array($resultado)){
                                ?>
                                <tr>
                                ...
                                $consulta="SELECT * FROM acumulado_compras WHERE nit_empresa='$_SESSION[empresa]' and cedua_cliente='$_SESSION[user]'  and  numero_factura='$_POST[buscar]' ";
                                $resultado=mysqli_query($con,$consulta);
                                while ($empresa=mysqli_fetch_array($resultado)){
                                    ?>
                                    <tr>
