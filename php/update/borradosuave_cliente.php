...
if ($_POST['tipo_opcion']==1){
    ...
    set usuario_borro='$_SESSION[user]',fecha_borrado='$fecha_actual' WHERE cedula_cliente='$cedula' and nit_empresa='$_SESSION[empresa]' ";
    $resultado=mysqli_query($con,$actualizar);
    echo $actualizar;
}else if ($_POST['tipo_opcion']==2){
    $delete="DELETE FROM detalles_clientes where cedula_cliente='$cedula' and nit_empresa='$_SESSION[empresa]'";
